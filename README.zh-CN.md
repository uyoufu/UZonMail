...
15. **AI 支持**
    ...
    可以使用 AI 助手快速生成邮局友好的邮件正文和主题，实现更高效的邮件投递。

## 👍 主要优势

相较于市面上其它邮件群发软件，宇正群邮的优势主要有以下几点：

1. 软件开源，私有化部署，数据安全有保障
2. 企业级品质：多用户、大并发，硬件要求低，性能强大
3. Web 架构，可私有化部署，适配多平台
4. 真正支持所有邮箱，包括 Outlook OAuth2 发件
5. 现代化 UI，UI 设计位居同类软件第一名
6. 邮件支持取消订阅，保护您的声誉
7. 无限变量，无限可能，可用性超出想象
8. AI 大模型助手，帮助生成邮局友好的邮件，提高到达率
