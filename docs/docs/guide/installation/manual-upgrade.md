...
2. 可以打开 [历史版本 | 宇正群邮](https://uzonmail.uzoncloud.com/versions.html) 查看最新版本

## 更新步骤

1. 关闭宇正群邮
2. 备份 `appsettings.Production.json` 文件。服务器版本位于根目录，桌面端位于 `service` 目录
3. 从[历史版本 | 宇正群邮](https://uzonmail.uzoncloud.com/versions.html) 中下载最新版本并解压到原安装目录进行覆盖
...
{
  ... 其它配置
  "BaseUrl": "https://uzonmail.uzoncloud.com:443"
}
```
