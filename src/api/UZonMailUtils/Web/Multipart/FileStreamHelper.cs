...
namespace UzonMail.Utils.Web.Multipart
{
    ...
    public static class FileStreamingHelper
    {
        ...
        public static async Task<FormValueProvider> StreamFiles(
                ...
                if (hasContentDispositionHeader && contentDisposition != null)
                {
                    ...
                    */
                    if (MultipartRequestHelper.HasFileContentDisposition(contentDisposition))
                    {
                        ...
                        var safeFileName = WebUtility.HtmlEncode(
                            $"{DateTime.UtcNow.ToTimestamp()}_{WebUtility.HtmlEncode(fileName)}"
                        );
                        ...
                        using var targetFileStream = File.Create(
