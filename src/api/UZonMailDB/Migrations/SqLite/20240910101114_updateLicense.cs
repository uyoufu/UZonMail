...
namespace UzonMail.DB.Migrations.SqLite
{
    ...
    public partial class updateLicense : Migration
    {
        ...
        {
            migrationBuilder.DropColumn(name: "DateTime", table: "SystemSettings");

            migrationBuilder.DropColumn(name: "Json", table: "SystemSettings");

            migrationBuilder.DropColumn(name: "LongValue", table: "SystemSettings");

            migrationBuilder.DropColumn(name: "ReadDate", table: "SendingItems");
