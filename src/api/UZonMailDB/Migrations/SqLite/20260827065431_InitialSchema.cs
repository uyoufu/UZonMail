        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SynchronizationGeneration = table.Column<long>(
                        type: "INTEGER",
                        nullable: false
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReceivingAccountSenderLinks_ReceivingAccounts_ReceivingAccountId",
                        column: x => x.ReceivingAccountId,
                        principalTable: "ReceivingAccounts",
                        principalColumn: "Id"
                    );
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReceivingAccountPrimarySenders_ReceivingAccountSenderLinks_ReceivingAccountSenderLinkId_ReceivingAccountId",
                        columns: x => new { x.ReceivingAccountSenderLinkId, x.ReceivingAccountId },
                        principalTable: "ReceivingAccountSenderLinks",
                        principalColumns: new[] { "Id", "ReceivingAccountId" }
                    );
                    table.ForeignKey(
                        name: "FK_ReceivingAccountPrimarySenders_ReceivingAccounts_ReceivingAccountId",
                        column: x => x.ReceivingAccountId,
                        principalTable: "ReceivingAccounts",
                        principalColumn: "Id"
                    );
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceivingAccountPrimarySenders_ReceivingAccountSenderLinkId_ReceivingAccountId",
                table: "ReceivingAccountPrimarySenders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceivingAccountSenderLinks_ReceivingAccountId_SenderAccountId",
