        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ImapAccountId = table.Column<long>(type: "INTEGER", nullable: false),
                    ...
                    OAuthAccessTokenExpiresAtUtc = table.Column<DateTime>(type: "TEXT", nullable: true),
                    OAuthClientId = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ...
                    OAuthTenantId = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    OAuthTokenEndpoint = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    _id = table.Column<string>(type: "TEXT", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsHidden = table.Column<bool>(type: "INTEGER", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ImapAccountId = table.Column<long>(type: "INTEGER", nullable: false),
                    ImapAccountOutboxLinkId = table.Column<long>(type: "INTEGER", nullable: false),
                    _id = table.Column<string>(type: "TEXT", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsHidden = table.Column<bool>(type: "INTEGER", nullable: false)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImapAccountPrimaryOutboxes_ImapAccountOutboxLinks_ImapAccountOutboxLinkId_ImapAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImapMailboxSyncRuns_ImapMailboxes_ImapMailboxId_ImapAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncomingMailLocations_ImapMailboxes_ImapMailboxId_ImapAccountId",
                        columns: x => new { x.ImapMailboxId, x.ImapAccountId },
                        principalTable: "ImapMailboxes",
                        principalColumns: new[] { "Id", "ImapAccountId" });
                    table.ForeignKey(
                        name: "FK_IncomingMailLocations_IncomingMailMessages_IncomingMailMessageId_ImapAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendingItemInboxId = table.Column<long>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IncomingMailSendingItemLinks_SendingItemInboxes_SendingItemInboxId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ImapSyncCommands_ImapMailboxes_DestinationMailboxId_ImapAccountId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumns: new[] { "Id", "ImapAccountId" });
                    table.ForeignKey(
                        name: "FK_ImapSyncCommands_IncomingMailLocations_IncomingMailLocationId_ImapAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IncomingMailAuditEvents_ImapSyncCommands_ImapSyncCommandId_ImapAccountId",
                        columns: x => new { x.ImapSyncCommandId, x.ImapAccountId },
                        principalTable: "ImapSyncCommands",
                        principalColumns: new[] { "Id", "ImapAccountId" });
                    table.ForeignKey(
                        name: "FK_IncomingMailAuditEvents_ImapSyncRuns_ImapSyncRunId_ImapAccountId",
                        columns: x => new { x.ImapSyncRunId, x.ImapAccountId },
                        principalTable: "ImapSyncRuns",
                        principalColumns: new[] { "Id", "ImapAccountId" });
                    table.ForeignKey(
                        name: "FK_IncomingMailAuditEvents_IncomingMailLocations_IncomingMailLocationId_ImapAccountId",
                        columns: x => new { x.IncomingMailLocationId, x.ImapAccountId },
                        principalTable: "IncomingMailLocations",
                        principalColumns: new[] { "Id", "ImapAccountId" });
                    table.ForeignKey(
                        name: "FK_IncomingMailAuditEvents_IncomingMailMessages_IncomingMailMessageId_ImapAccountId",
                        columns: x => new { x.IncomingMailMessageId, x.ImapAccountId },
                        principalTable: "IncomingMailMessages",
                        principalColumns: new[] { "Id", "ImapAccountId" });
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImapAccountPrimaryOutboxes_ImapAccountOutboxLinkId_ImapAccountId",
                table: "ImapAccountPrimaryOutboxes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncomingMailMessages_ImapAccountId_BodyContentStatus_ReceivedAtUtc",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncomingMailMessages_ImapAccountId_CurrentBounceType_ReceivedAtUtc",
                table: "IncomingMailMessages",
                columns: new[] { "ImapAccountId", "CurrentBounceType", "ReceivedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_IncomingMailMessages_ImapAccountId_CurrentPrimaryClassification_ReceivedAtUtc",
                table: "IncomingMailMessages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncomingMailSendingItemLinks_IncomingMailMessageId_SendingItemId_SendingItemInboxId_LinkType",
