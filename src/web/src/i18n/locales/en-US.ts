export default {
  ...
  outboxManager: {
    ...
    detectedExchangeEmailStartingOutlookDelegateAuthorization:
      'Detected personal Outlook email, delegate authorization required, please approve the authorization window',
    ...
    emailFormatInvalid: 'Invalid email format: {email}',
    existingRefreshTokenNoNeedDelegateAuthorization:
      'This email has already obtained refreshToken, no need for delegate authorization',
    ...
    outlookDelegateAuthorizationSkippedEncryptedPassword:
      'Detected that the outbox password is encrypted, skipping delegate authorization',
    outlookDelegateAuthorizationSkippedNonExchangeSmtp:
      'Detected Outlook email, but SMTP address is not Exchange address, skipping delegate authorization',
    outlookDelegateAuthorizationSkippedNonMsGraphType:
      'Detected that the outbox is not MsGraph type, skipping delegate authorization',
    outlookSmtpNotExchange:
      'Detected Outlook email, but SMTP address is not Exchange address, skipping delegate authorization',
    personalOutlookNeedsAuthorization:
      'Detected personal Outlook email, delegate authorization required, please approve',
  ...
  sendingTask: {
    ...
    sendBatchTooltips:
      'If there are multiple senders, they will be merged into one email\nOnce enabled you cannot resend for a single outbox\nNot generally recommended',
    sender: 'Sender',
